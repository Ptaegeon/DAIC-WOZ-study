...
def main(dataloaders, visual_net, audio_net, evaluator, base_logger, writer, config, args, model_type, ckpt_path):
...
if __name__ == '__main__':
    ...
    visual_net, audio_net, evaluator = get_models(config['MODEL'], args, model_type, ckpt_path)

    main(dataloaders, visual_net, audio_net, evaluator, base_logger, writer, config['MODEL'], args, model_type, ckpt_path)
